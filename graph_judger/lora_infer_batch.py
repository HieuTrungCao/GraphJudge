...
if __name__ == "__main__":
    ...
    parser.add_argument("--finput", type=str, default="data/test_instructions_llama2_7b_itr1.csv")
    parser.add_argument("--foutput", type=str, default="data/pred_test_instructions_llama2_7b_itr1.csv")  # pred_instructions_context_genwiki_llama2_7b_itr1.csv
