...
if __name__ == '__main__':
    ...
    with open(args.pred_file, 'r', encoding="utf-8") as f:
        for line in f.readlines():
            ...
            if len(result) > 1:
                ...
                result = result[0]
            try:
                pred_graphs.append(ast.literal_eval(result.strip()))
            except:
    ...
    # print("Compute GED...")
    # overall_ged = 0.
    # for i in tqdm(range(len(gold_graphs))):
    ...
    print("Precisions bleu: ", precisions_bleu.sum())
    ...
    print("Precisions bert score: ", precisions_BS.sum())
